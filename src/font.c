#include "font.h"
//the reason SOME characters are commented is because... for some reason they cause you not being able to type in text mode when swithing to it from desktop
const uint8_t font8x8[128][8] = {
    [0 ... 31] = {0},
    [32] = {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, //' ' space i mean
    ...
    [64] = {0x3C, 0x42, 0x59, 0x55, 0x79, 0x02, 0x3C, 0x00}, //@
    ...
    [109] = {0x00,0x00,0x36,0x7F,0x7F,0x6B,0x63,0x00}, //m
    [110] = {0x00,0x00,0x3E,0x33,0x33,0x33,0x33,0x00}, //n
